<div class="d-flex gap-2 align-items-center">
    <a href="{{route("backend.coupons-view", ['id' => $data->id])}}" class="btn btn-soft-danger btn-sm" data-type="ajax" data-bs-toggle="tooltip" title="{{__('messages.coupon_view')}}"> <i class="fa-solid fa-table"></i></a>
