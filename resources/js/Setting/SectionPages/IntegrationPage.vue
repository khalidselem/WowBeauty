<template>
  <form @submit="formSubmit">
    ...
    <div v-if="firebase_notification == 1">
      <div class="row">
        <div class="col-md-4">
          <InputField class="col-md-12" type="text" :is-required="true" :label="$t('setting_integration_page.lbl_api_key')" placeholder="" v-model="firebase_key" :error-message="errors['firebase_key']" :error-messages="errorMessages['firebase_key']"></InputField>
        </div>        
      </div>
    </div>
...
const validationSchema = yup.object({
  ...
  firebase_key: yup.string().test('firebase_key','Must be a valid Firebase Key', function(value) {
